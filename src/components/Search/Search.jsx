      ...
      <>
        ...
        <div className='flex flex-col relative h-9'>
          <div className="search flex px-[3px] py-[0px] border-[1.5px] bg-[#fff] border-[#d9d9d9] justify-center items-center gap-1 rounded-lg shadow-md shadow-[rgba(48,50,51,0.0)]">
            <div onClick={handleSearchSubmit} className=" h-[28px] w-[28px] border-[1.5px] bg-[#f8f8f8] border-[#d9d9d9] rounded-lg p-1 cursor-pointer  flex justify-center items-center ">
              <svg
                width="16"
                height="16"
                viewBox="0 0 33 33"
            ...
            <input
              ...
              onClick={() => setIsExpanded(true)}
            />
            <div className="border-[1.5px] border-[#d9d9d9] bg-[#f8f8f8] text-[#b9b9b9] text-[16px] p-1 h-[28px] w-[28px] flex justify-center items-center rounded-md font-[400] ">⌘K</div>
          </div>
          {isExpanded && (
              ...
              <div className='flex flex-col w-full justify-center items-center'>
                ...
                {popularSearches.map((company, index) => (
                  <div className='px-2 py-2 flex flex-row w-full justify-between items-center hover:bg-[#f8f8f8] '>
                    <div className='pl-2 w-[400px] hover:bg-[#f8f8f8] ' key={index}>{company}</div>
                  </div>
                ))}
              </div>
              {recentSearches.length === 0 ? (
