...
const Search = ({ mode, focus, full }) => {
  ...
  const popularSearches = ["Amazon", "Google", "Facebook", "Microsoft"];
        ...
        <div className="flex flex-col relative">
          <div className="search flex px-[4px] py-[1px] border-[1.5px] bg-[rgb(33,33,33)] border-[#414141] justify-center items-center gap-1 rounded-lg shadow-md shadow-[rgba(48,50,51,0.3)]">
            <div
              ...
              className=" h-[32px] w-[32px] border-[1.5px] bg-[#313131] border-[#414141] rounded-lg p-1 cursor-pointer  flex justify-center items-center "
            >
              <svg
                width="24"
                height="24"
              ...
              <div className="flex flex-col w-full justify-center items-center">
                ...
                {popularSearches.map((company, index) => (
                  <div className="px-2 py-2 flex flex-row w-full justify-between items-center hover:bg-[#313131] ">
                    <div
                      className="pl-2 w-[400px] hover:bg-[#313131] "
                      key={index}
                    >
                      {company}
                    </div>
    ...
    return (
      <>
        ...
        <div className="flex flex-col relative h-9">
          <div className="search flex px-[3px] py-[0px] border-[1.5px] bg-[#fff] border-[#d9d9d9] justify-center items-center gap-1 rounded-lg shadow-md shadow-[rgba(48,50,51,0.0)]">
            <div
              onClick={handleSearchSubmit}
            ...
            <input
              ref={inputRef}
              className="bg-[#fff] text-[#212121] h-[34px]  w-[280px] lg:w-[500px] border-none outline-none focus:outline-none placeholder:text-[#818181] placeholder:font-[300] font-[300] placeholder:focus:outline-none placeholder:focus:border-none placeholder:focus:text-[#616161]"
              type="text"
              placeholder="Enter cmd+k to search"
              value={searchText}
              onKeyDown={handleClose}
              onChange={handleInputChange}
              onClick={() => setIsExpanded(true)}
            />
            <div className="border-[1.5px] border-[#d9d9d9] bg-[#f8f8f8] text-[#b9b9b9] text-[16px] p-1 h-[28px] w-[28px] flex justify-center items-center rounded-md font-[400] ">
              ⌘K
            </div>
          </div>
          {isExpanded && (
            <div className=" z-50 overflow-hidden absolute top-[35.2px] flex flex-col font-[300] text-sm text-[#212121] bg-[#fff] w-full recent-searches border-[1.5px] border-[#d9d9d9] justify-start items-center rounded-lg shadow-md shadow-[rgba(48,50,51,0.0)]">
              {/* Conditional rendering for recent searches */}
              <div className="flex flex-col w-full justify-center items-center">
                <div className="overflow-hidden px-2 pt-2 pb-1  w-full font-[400] tracking-wider">
                  Popular Searches
                </div>
                <div className="w-full h-[1px] bg-[#f8f8f8]"></div>
                {popularSearches.map((company, index) => (
                  <div className="px-2 py-2 flex flex-row w-full justify-between items-center hover:bg-[#f8f8f8] ">
                    <div
                      className="pl-2 w-[400px] hover:bg-[#f8f8f8] "
                      key={index}
                    >
                      {company}
                    </div>
              ...
              {recentSearches.length === 0 ? (
                ...
                <>
                  ...
                  <div className="w-[480px] h-[1px] bg-[#f8f8f8]"></div>
                  {recentSearches
                    .slice(0)
                    .reverse()
                    .map((search, index) => (
