...
const Logo: React.FC<Props> = () => {
    ...
    return (
        <svg className="logo" width="131" height="115" viewBox="0 0 131 116" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
                ...
                strokeWidth="0.5" />
            <defs>
                <linearGradient id="paint0_linear_774_7480" x1="65.5" y1="0" x2="65.5" y2="114.995" gradientUnits="userSpaceOnUse">
                    <stop offset="0.25" stopColor="white" />
                    <stop offset="1" stopColor="#f0f0f0" />
                </linearGradient>
                <linearGradient id="paint1_linear_774_7480" x1="79.5" y1="143.995" x2="51.5" y2="-29" gradientUnits="userSpaceOnUse">
