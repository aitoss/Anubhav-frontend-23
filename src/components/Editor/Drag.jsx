...
const DragDropFiles = () => {
  ...
  return (
    <>
   <section className="p-8 -mb-3 w-screen flex justify-center items-center">
  <div
    className="dropzone p-8 w-[83.7%] h-full rounded-xl flex flex-col justify-center items-center border-dotted border-[4px]"
