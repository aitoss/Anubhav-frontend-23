        ...
        <>
            ...
            <div className="category2">
                ...
                <div className="flex flex-col gap-1 ">
                    ...
                    >
                        {MostPopular && <div className='absolute w-1 h-4 bg-[#919191] rounded-full top-2 -left-2'></div>}
                        <h5>Most Popular</h5>
                    </div>
                    <div
                    ...
                    >
                        {MostRecent && <div className='absolute w-1 h-4 bg-[#919191] rounded-full top-2 -left-2'></div>}
                        <h5>Most Recent</h5>
                    </div>
                    <div
                    ...
                    >
                        {MostViewed && <div className='absolute w-1 h-4 bg-[#919191] rounded-full top-2 -left-2'></div>}
                        <h5>Most Viewed</h5>
                    </div>
                </div>
            </div>
            ...
            <div className='flex justify-start'>
                <div
                    ...
                    className='bg-[#fff] text-[#212121] border px-4 py-1 rounded-md hover:bg-[#f0f0f0] font-[400] cursor-pointer transition-all'>Apply</div>
            </div>
        </>
    )
}
