    ...
    <>
      <Link to={link} className="pb-2 border-b" >
        <div className="flex flex-row x-sm:flex-col w-full h-full justify-center items-center lg:gap-10 gap-4 p-1">
          ...
          <div style={{ width: 'min-content'}} className="data flex items-start lg:justify-start justify-between h-full flex-col grow lg:gap-2 gap-2 x-sm:gap-1 p-1 sm:self-start ">
