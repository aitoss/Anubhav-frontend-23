...
const Navbar = () => {
    ...
    const navClasses = `bg-[#ffffffcc] bg-blur border-b flex item-center justify-center h-[70px] p-3 lg:block w-screen text-black fixed top-0 z-10 transition-transform transform ${visible ? 'translate-y-0' : '-translate-y-full'
        }`;
