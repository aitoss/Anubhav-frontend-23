            ...
            <nav className={navClasses} aria-label="Global">
                <div className="flex w-full h-full justify-between items-center max-w-[1400px] m-auto">
                    <div className="flex w-full items-center justify-between px-1 lg:px-8">
                        ...
                        <div className="flex justify-center items-center gap-2">
                            <div onClick={() => { openSearchMobile() }} className="md:flex hidden h-[28px] w-[28px] border-[1.5px] bg-[#f8f8f8] border-[#d9d9d9] rounded-lg p-1 cursor-pointer justify-center items-center ">
                                <svg
                                    width="16"
                                    height="16"
                                    viewBox="0 0 33 33"
