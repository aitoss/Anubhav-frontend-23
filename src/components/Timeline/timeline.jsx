...
export const Timeline = ({ data }) => {
  ...
  return (
    <div
      ...
      ref={containerRef}
    >
      <div ref={ref} className="relative max-w-7xl w-full mx-auto pb-20">
        {data.map((item, index) => (
          <div
            key={index}
            className="flex flex-col items-center justify-center md:justify-start pt-6 md:pt-40 md:gap-10"
          >
