            ...
            <div className="flex flex-col items-center min-h-full">
                <section className="mx-auto w-[100%] h-full max-w-[1400px] lg:w-[70%] px-4 py-8 overflow-y-auto">
                    <div className="text-xl text-black">
                        ...
                        <div className="space-y-8 pt-4 relative before:absolute before:inset-0 before:ml-5 before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-transparent before:via-slate-300 before:to-transparent">
                            {/* Item 1 */}
                            <div className="relative flex items-center justify-center md:justify-normal md:odd:flex-row-reverse group is-active">
                                {/* Card */}
                                <div className="w-[580px] md:w-[calc(50%-2.5rem)] p-4 rounded-3xl border shadow">
