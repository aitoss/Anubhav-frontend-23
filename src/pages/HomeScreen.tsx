...
export default function HomeScreen() {
  ...
  <div className='w-full h-[10vh]'></div>
    <div className="flex flex-col w-full lg:py-24 justify-center" style={{ backgroundImage: `url(${background2})`, backgroundPosition: 'center', backgroundRepeat: 'no-repeat' }}>
    ...
    <div className="w-full pb-5"><Slider /></div>
